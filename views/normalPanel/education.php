    ...
    <div class="container">
        ...
        <div class="owl-carousel own-theme pt-4">
            ...
            foreach ($menuItems2 as $item) {
                ...
                <a href="education_Detail.php?lesson_id=' . $item["lesson_id"] . '&educator_id=' . $item["educator_id"] . '"><h5>Devamını Oku</h5></a> // Burada lesson_id veya benzeri bir benzersiz kimlik kullanmalısınız.
               </div>';
            }
            ?>
        </div>
